      ...
      <Disclosure as="nav" className="">
        <div className="mx-auto px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-20 items-center justify-between">
            ...
            <div className="absolute inset-y-0 right-0  items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 sm:flex sm:space-x-4 hidden ">
        ...
        <DisclosurePanel className="sm:hidden absolute z-50 bg-black w-full">
